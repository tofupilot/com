...
module.exports = {
  ...
  theme: {
    ...
    extend: {
      ...
      keyframes: {
        ...
        // landing page Tremor Database template
        hide: {
          from: { opacity: "1" },
          to: { opacity: "0" },
        },
  ...
  safelist: [
    { pattern: /^bg-/ }, // TODO: remove when disabling dynamiccyly constructued classes in my code https://tailwindcss.com/docs/content-configuration
    { pattern: /^text-/ },
    {
      pattern:
