        ...
        <div className="mx-auto flex max-w-xl flex-col py-12 sm:py-20">
          <div className="mb-8">
            <div className="text-center flex justify-center gap-2">
              <a 
                href="https://github.com/tofupilot/com/releases"
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center px-3 py-1.5 text-sm font-medium rounded-md bg-zinc-100 text-zinc-700 hover:bg-zinc-200 dark:bg-zinc-800 dark:text-zinc-300 dark:hover:bg-zinc-700 transition-colors"
              >
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" width="14" height="14" fill="currentColor" className="mr-1.5">
