    ...
    <div>
      ...
      <div className="mx-auto px-4 sm:px-6 lg:max-w-7xl lg:px-8">
        <div className="lg:grid lg:grid-cols-7 lg:gap-x-8 xl:gap-x-16">
          ...
          <article className="mx-auto mt-16 w-full max-w-2xl lg:col-span-4 lg:mt-8 lg:max-w-none prose-headings:font-display prose my-3 overflow-x-auto text-base leading-7 text-zinc-700 dark:prose-invert focus:outline-none prose-a:text-zinc-600 dark:text-zinc-300 dark:prose-a:text-zinc-400">
